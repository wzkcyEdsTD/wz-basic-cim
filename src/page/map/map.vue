    ...
    <div class="map" v-if="currentMapType == 'sandian'">
      ...
      >
        <div class="right-title">
          {{ treeCheckedList[typeIndex] && treeCheckedList[typeIndex].name }}
        </div>
      ...
      if (this.currentOnePoint) {
        ...
        if (
          ...
          if (
            ...
            (this.currentOnePoint.children && this.currentOnePoint.children.length === 0)
          ) {
